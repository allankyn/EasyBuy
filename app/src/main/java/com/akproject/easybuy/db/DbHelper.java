...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(DbTable.PaymentMethod.SQL_CREATE_ENTRIES);
        db.execSQL(DbTable.Transaction.SQL_CREATE_ENTRIES);
        db.execSQL(DbTable.TransactionAttrRel.SQL_CREATE_ENTRIES);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        LogManager.logSystem(oldVersion + " "+ newVersion);
        ...
        if (oldVersion >= 43) {
            exportStringBuilder.append(DbTable.PaymentMethod.TABLE_NAME);
            exportStringBuilder.append("\r\n");
            exportStringBuilder.append(dbFunction.getExport(null, db, DbTable.PaymentMethod.SQL_EXPORT));
        }
        exportStringBuilder.append(DbTable.Transaction.TABLE_NAME);
        exportStringBuilder.append("\r\n");
        if (oldVersion < 43) {
            exportStringBuilder.append(dbFunction.getExport(null, db, DbTable.Transaction.SQL_EXPORT_38));
        } else {
        ...
        if (oldVersion > 24) {
            ...
            exportStringBuilder.append("\r\n");
            exportStringBuilder.append(dbFunction.getExport(null, db, DbTable.TransactionAttrRel.SQL_EXPORT));
        }
        ...
        // Drop tables
        if (oldVersion >= 24) {
            db.execSQL(DbTable.TransactionAttrRel.SQL_DELETE_ENTRIES);
        }
        db.execSQL(DbTable.Transaction.SQL_DELETE_ENTRIES);
        if (oldVersion >= 43) {
            db.execSQL(DbTable.PaymentMethod.SQL_DELETE_ENTRIES);
        }
        ...
        for (int i=0; i<dbInitScript.size(); i++) {
            LogManager.logSystem(dbInitScript.get(i));
        ...
        try {
            ...
            while ((strLine = bufferedReader.readLine()) != null)   {
                if (strLine.equals(DbTable.DisplayText.TABLE_NAME)) {
                    ...
                    tableNum = 4;
                }else if (strLine.equals(DbTable.PaymentMethod.TABLE_NAME)) {
                    tableNum = 7;
                    ...
                    if (strLineParts.length > 0 && strLineParts[0] != null && (Integer.parseInt(strLineParts[0]) > 10000 || tableNum == 5 || tableNum == 6)) {
                        switch (tableNum) {
                            case 1:
                            ...
                            case 7:
                                if (strLineParts.length == 5) {
                                    db.execSQL(String.format(DbTable.PaymentMethod.SQL_INSERT,
                                            Integer.parseInt(strLineParts[0]),
                                            Integer.parseInt(strLineParts[1]),
                                            Integer.parseInt(strLineParts[2]),
                                            Integer.parseInt(strLineParts[3]),
                            ...
                            case 5:
                                if (strLineParts.length == 10) {
                                    ...
                                    db.execSQL(String.format(DbTable.Transaction.SQL_INSERT,
                                            ...
                                            strLineParts[5].replace("\"", ""),
                                            strLineParts[6].replace("\"", ""),
                                            Integer.parseInt(strLineParts[10]),
                                            Integer.parseInt(strLineParts[7]),
                                            Integer.parseInt(strLineParts[8]),
                                            strLineParts[9].replace("\"", "")));
                                }
                            ...
                            case 6:
                                if (strLineParts.length == 4) {
                                    db.execSQL(String.format(DbTable.TransactionAttrRel.SQL_INSERT,
                                            Integer.parseInt(strLineParts[0]),
                                            Integer.parseInt(strLineParts[1]),
                                            Integer.parseInt(strLineParts[2]),
                                            strLineParts[3].replace("\"", "")));
    ...
    private void initializeTables(SQLiteDatabase db, int oldVersion) {
        ...
        if (oldVersion <= 24) {
            LogManager.logSystem("Start Initialize V5");
            db.execSQL(String.format(DbTable.DisplayText.SQL_INSERT, 167, 1, "現金", 1, "2016-01-01"));
            db.execSQL(String.format(DbTable.DisplayText.SQL_INSERT, 168, 1, "信用咭", 1, "2016-01-01"));
            db.execSQL(String.format(DbTable.DisplayText.SQL_INSERT, 169, 1, "八逹通", 1, "2016-01-01"));
            db.execSQL(String.format(DbTable.DisplayText.SQL_INSERT, 170, 1, "Tap & Go", 1, "2016-01-01"));
            db.execSQL(String.format(DbTable.DisplayText.SQL_INSERT, 171, 1, "Coupon", 1, "2016-01-01"));
            db.execSQL(String.format(DbTable.DisplayText.SQL_INSERT, 172, 1, "唔使我俾", 1, "2016-01-01"));
            LogManager.logSystem("Initialize on DisplayText completes");
            db.execSQL(String.format("Update %s Set %s = %d Where %s = %d",
                    DbTable.Attribute.TABLE_NAME, DbTable.Attribute.COLUMN_NAME_TYPE, 2, DbTable.Attribute.COLUMN_NAME_ATTRIBUTE_ID, 23));
            db.execSQL(String.format("Update %s Set %s = %d Where %s = %d",
                    DbTable.Attribute.TABLE_NAME, DbTable.Attribute.COLUMN_NAME_TYPE, 2, DbTable.Attribute.COLUMN_NAME_ATTRIBUTE_ID, 24));
            db.execSQL(String.format("Update %s Set %s = %d Where %s = %d",
                    DbTable.Attribute.TABLE_NAME, DbTable.Attribute.COLUMN_NAME_TYPE, 2, DbTable.Attribute.COLUMN_NAME_ATTRIBUTE_ID, 25));
            db.execSQL(String.format("Update %s Set %s = %d Where %s = %d",
                    DbTable.Attribute.TABLE_NAME, DbTable.Attribute.COLUMN_NAME_TYPE, 2, DbTable.Attribute.COLUMN_NAME_ATTRIBUTE_ID, 26));
            db.execSQL(String.format("Update %s Set %s = %d Where %s = %d",
                    DbTable.Attribute.TABLE_NAME, DbTable.Attribute.COLUMN_NAME_TYPE, 2, DbTable.Attribute.COLUMN_NAME_ATTRIBUTE_ID, 27));
            db.execSQL(String.format(DbTable.Attribute.SQL_INSERT, 28, 3, 167, 1, 1, 1, "2016-01-01"));
            db.execSQL(String.format(DbTable.Attribute.SQL_INSERT, 29, 3, 168, 1, 2, 1, "2016-01-01"));
            db.execSQL(String.format(DbTable.Attribute.SQL_INSERT, 30, 3, 169, 1, 3, 1, "2016-01-01"));
            db.execSQL(String.format(DbTable.Attribute.SQL_INSERT, 31, 3, 170, 1, 4, 1, "2016-01-01"));
            db.execSQL(String.format(DbTable.Attribute.SQL_INSERT, 32, 3, 171, 1, 5, 1, "2016-01-01"));
            db.execSQL(String.format(DbTable.Attribute.SQL_INSERT, 33, 3, 172, 1, 6, 1, "2016-01-01"));
            LogManager.logSystem("Initialize on Attribute completes");
        }
        if (oldVersion <= 29) {
            LogManager.logSystem("Start Initialize V5_2");
            db.execSQL(String.format("Update %s Set %s = %d Where %s = %d",
                    DbTable.Attribute.TABLE_NAME, DbTable.Attribute.COLUMN_NAME_TYPE, 3, DbTable.Attribute.COLUMN_NAME_ATTRIBUTE_ID, 28));
            db.execSQL(String.format("Update %s Set %s = %d Where %s = %d",
                    DbTable.Attribute.TABLE_NAME, DbTable.Attribute.COLUMN_NAME_TYPE, 3, DbTable.Attribute.COLUMN_NAME_ATTRIBUTE_ID, 29));
            db.execSQL(String.format("Update %s Set %s = %d Where %s = %d",
                    DbTable.Attribute.TABLE_NAME, DbTable.Attribute.COLUMN_NAME_TYPE, 3, DbTable.Attribute.COLUMN_NAME_ATTRIBUTE_ID, 30));
            db.execSQL(String.format("Update %s Set %s = %d Where %s = %d",
                    DbTable.Attribute.TABLE_NAME, DbTable.Attribute.COLUMN_NAME_TYPE, 3, DbTable.Attribute.COLUMN_NAME_ATTRIBUTE_ID, 31));
            db.execSQL(String.format("Update %s Set %s = %d Where %s = %d",
                    DbTable.Attribute.TABLE_NAME, DbTable.Attribute.COLUMN_NAME_TYPE, 3, DbTable.Attribute.COLUMN_NAME_ATTRIBUTE_ID, 32));
            db.execSQL(String.format("Update %s Set %s = %d Where %s = %d",
                    DbTable.Attribute.TABLE_NAME, DbTable.Attribute.COLUMN_NAME_TYPE, 3, DbTable.Attribute.COLUMN_NAME_ATTRIBUTE_ID, 33));
            LogManager.logSystem("Initialize on Attribute completes");
        }
