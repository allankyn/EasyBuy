 ...
 */
public class DbHelper_v3 extends SQLiteOpenHelper {
    ...
    public DbHelper_v3(Context context) {
            ...
            while ((strLine = bufferedReader.readLine()) != null)   {
                ...
                if (strLine.equals(DbTable.DisplayText.TABLE_NAME)) {
                    ...
                    tableNum = 5;
                        ...
                        LogManager.logSystem(String.format("Item: %s; Content: %s; Size: %d", tableNum, strLine, strLineParts.length));
                        switch (tableNum) {
                        case 1:
    ...
    private void initializeTables(SQLiteDatabase db) {
        LogManager.logSystem("Start Initialize");
        ...
        db.execSQL(String.format(DbTable.Attribute.SQL_INSERT, 10, 1, 10, 1, 10, 1, "2016-01-01"));
        ...
        db.execSQL(String.format(DbTable.Attribute.SQL_INSERT, 19, 1, 19, 1, 19, 1, "2016-01-01"));
        db.execSQL(String.format(DbTable.Attribute.SQL_INSERT, 20, 1, 20, 1, 20, 1, "2016-01-01"));
